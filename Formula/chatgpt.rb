class Chatgpt < Formula
  ...
  sha256 "e2c3acdd7732f252fd88bc548fa87464551930a18ecd81fc18953f5578283ad8"
  license "MIT"
 ...
 test do
  assert_predicate bin/"chatgpt", :exist?
  assert_match "v0.2.0", shell_output("#{bin}/chatgpt --version")
  assert_match "ls .", shell_output("#{bin}/chatgpt list files in current directory")
  end
end
